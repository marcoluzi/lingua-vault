...
<div>
    <x-modal-card>
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model.defer="meaning" class="mt-1 block w-full rounded-md border-gray-300 shadow-xs">
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model.defer="romanized" class="mt-1 block w-full rounded-md border-gray-300 shadow-xs">
            {{-- TODO: Fixing error messages. Currently only displaying keys --}}
            @error('romanized')
                <span class="text-sm text-red-500">{{ $message }}</span>
            @enderror
