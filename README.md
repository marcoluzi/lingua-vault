...
Each word is presented as an interactive element that reflects its learning status through color-coding, and users can easily edit or create associated words or expressions by providing translations, optional romanizations, and a status rating. Behind the scenes, the app leverages a proven spaced repetition system based on the SM‑2 algorithm to optimize retention and ensure that each word is reviewed at just the right time.
